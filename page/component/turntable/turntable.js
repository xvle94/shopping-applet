...
var Pointer = require('../../util/Pointer.js');
...
Page({
  ...
  getPrize(){
    var that=this;
    app.getReq('/api/applet/prize/All','',(res)=>{
        that.setData({
          prize:res.result
        })
    })
  },
  ...
  onReady: function () {
    ...
    var that = this,
      ...
      slicePrizes = [
        { text: "恭喜中了大奖", img: "/image/gift.png" },
        { text: "50 积分", img: "/image/gift.png" },
        { text: "500 积分", img: "/image/gift.png" },
        { text: "谢谢参与", img: "/image/gift.png" },
        { text: "200 积分", img: "/image/gift.png" },
        { text: "100 积分", img: "/image/gift.png" },
        { text: "150 积分", img: "/image/gift.png" },
        { text: "谢谢参与", img: "/image/gift.png" }
      ],
